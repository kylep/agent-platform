...
# openapi-python-client can tailor its output to the running Python, so the
# committed SDK must be generated on the SAME version CI/prod uses — 3.12 — or
# the CI drift check may fail on a version-only diff. Regenerate with a 3.12
# interpreter, e.g.:
