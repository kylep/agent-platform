...
from ...models.report_in import ReportIn
from ...models.report_saved import ReportSaved
...
def _parse_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
    ...
    if response.status_code == 201:
        response_201 = ReportSaved.from_dict(response.json())
...
def sync(
    *,
    ...
    Returns:
        HTTPValidationError | ReportSaved
    """
