...
export const CONNECTION_GUIDES: ConnectionGuide[] = [
  ...
  { id: "gemini-images", title: "Gemini image generation", mark: "G", purpose: "Gemini image models in Studio.", secrets: ["gemini-api-key"],
  ...
  { id: "bfl-images", title: "Black Forest Labs image generation", mark: "B", purpose: "FLUX image models in Studio.", secrets: ["bfl-api-key"],
  ...
  { id: "strava", title: "Strava", mark: "S", purpose: "Running activities and coaching data.", secrets: ["strava"],
  ...
  { id: "linear", title: "Linear", mark: "L", purpose: "Read and write Linear issues and projects.", secrets: ["linear-api-key"],
  ...
  { id: "github-app", title: "GitHub App", mark: "GH", purpose: "Platform change publishing and pull requests.", secrets: ["github-app"],
  ...
  { id: "claude", title: "Claude subscription", mark: "C", purpose: "Claude Code runner authentication.", secrets: ["claude-credentials"],
  ...
  { id: "codex", title: "Codex subscription", mark: "Cx", purpose: "Codex runner authentication with your ChatGPT account.", secrets: ["codex-credentials"],
