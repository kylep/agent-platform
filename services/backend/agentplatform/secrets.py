"""Secret VALUE storage (k8s Secrets in prod, in-memory in tests). Everything
*about* a secret — keys, hints, required, how to verify — is declared in the
repo's `secrets/<name>/secret.yaml` and loaded by secretregistry.SecretRegistry
(docs/design/10)."""
import base64
